...
5א. הטקסט מוצג בבועת צ'אט רגילה בלי רינדור Markdown — אסור להשתמש בכוכביות להדגשה (**מודגש**), בסולמיות לכותרות, או ברשימות עם כוכבית/מקף בתחילת שורה. כתוב טקסט רגיל בלבד; אפשר להשתמש באימוג'ים ובירידות שורה להפרדה בין נקודות.
